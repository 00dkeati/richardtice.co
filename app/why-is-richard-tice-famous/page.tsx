...
export const metadata: Metadata = {
  title: "Why Is Richard Tice Famous? | RichardTice.co",
  description: "Learn about why is richard tice famous?. Richard Tice is the Deputy Leader of Reform UK and MP for Boston & Skegness. Net worth £40 million, engaged to Isabel Oakeshott.",
  keywords: ["why", "is", "richard", "tice", "famous", "richard tice", "reform uk", "boston skegness mp"],
  openGraph: {
    title: "Why Is Richard Tice Famous?",
    description: "Learn about why is richard tice famous?. Richard Tice - Reform UK Deputy Leader.",
    url: "https://richardtice.co/why-is-richard-tice-famous",
    ...
    <main className="min-h-screen bg-slate-900">
      ...
      <section className="py-12 bg-gradient-to-b from-slate-800 to-slate-900">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">Why Is Richard Tice Famous?</h1>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            "headline": "Why Is Richard Tice Famous?",
