...
export const metadata: Metadata = {
  title: "What Does Richard Tice Do? | RichardTice.co",
  description: "Learn about what does richard tice do?. Richard Tice is the Deputy Leader of Reform UK and MP for Boston & Skegness. Net worth £40 million, engaged to Isabel Oakeshott.",
  keywords: ["what", "does", "richard", "tice", "do", "richard tice", "reform uk", "boston skegness mp"],
  openGraph: {
    title: "What Does Richard Tice Do?",
    description: "Learn about what does richard tice do?. Richard Tice - Reform UK Deputy Leader.",
    url: "https://richardtice.co/what-does-richard-tice-do",
    ...
    <main className="min-h-screen bg-slate-900">
      ...
      <section className="py-12 bg-gradient-to-b from-slate-800 to-slate-900">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">What Does Richard Tice Do?</h1>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            "headline": "What Does Richard Tice Do?",
