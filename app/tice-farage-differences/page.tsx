...
export const metadata: Metadata = {
  title: "Tice & Farage Differences | RichardTice.co",
  description: "Learn about tice & farage differences. Richard Tice is the Deputy Leader of Reform UK and MP for Boston & Skegness. Net worth £40 million, engaged to Isabel Oakeshott.",
  keywords: ["tice", "farage", "differences", "richard tice", "reform uk", "boston skegness mp"],
  openGraph: {
    title: "Tice & Farage Differences",
    description: "Learn about tice & farage differences. Richard Tice - Reform UK Deputy Leader.",
    url: "https://richardtice.co/tice-farage-differences",
    ...
    <main className="min-h-screen bg-slate-900">
      ...
      <section className="py-12 bg-gradient-to-b from-slate-800 to-slate-900">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">Tice & Farage Differences</h1>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            "headline": "Tice & Farage Differences",
