...
export const metadata: Metadata = {
  title: "Richard Tice Net Worth 2026 | RichardTice.co",
  description: "Learn about richard tice net worth 2026. Richard Tice is the Deputy Leader of Reform UK and MP for Boston & Skegness. Net worth £40 million, engaged to Isabel Oakeshott.",
  keywords: ["richard", "tice", "net", "worth", "2026", "richard tice", "reform uk", "boston skegness mp"],
  openGraph: {
    title: "Richard Tice Net Worth 2026",
    description: "Learn about richard tice net worth 2026. Richard Tice - Reform UK Deputy Leader.",
    url: "https://richardtice.co/richard-tice-net-worth-2026",
    ...
    <main className="min-h-screen bg-slate-900">
      ...
      <section className="py-12 bg-gradient-to-b from-slate-800 to-slate-900">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">Richard Tice Net Worth 2026</h1>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="prose prose-invert prose-lg max-w-none">
            ...
            <p className="text-xl text-slate-300 mb-6">
              In 2026, Richard Tice's net worth is estimated at approximately <strong className="text-green-400">£40 million</strong>.
            </p>
            
            <h2 className="text-2xl font-bold mt-8 mb-4">Net Worth Breakdown 2026</h2>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            "headline": "Richard Tice Net Worth 2026",
