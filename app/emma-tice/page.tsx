...
export const metadata: Metadata = {
  title: "Emma Tice - Richard Tice Ex-Wife | RichardTice.co",
  description: "Learn about emma tice - richard tice ex-wife. Richard Tice is the Deputy Leader of Reform UK and MP for Boston & Skegness. Net worth £40 million, engaged to Isabel Oakeshott.",
  keywords: ["emma", "tice", "richard tice", "reform uk", "boston skegness mp"],
  openGraph: {
    title: "Emma Tice - Richard Tice Ex-Wife",
    description: "Learn about emma tice - richard tice ex-wife. Richard Tice - Reform UK Deputy Leader.",
    url: "https://richardtice.co/emma-tice",
    ...
    <main className="min-h-screen bg-slate-900">
      ...
      <section className="py-12 bg-gradient-to-b from-slate-800 to-slate-900">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">Emma Tice - Richard Tice Ex-Wife</h1>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            "headline": "Emma Tice - Richard Tice Ex-Wife",
