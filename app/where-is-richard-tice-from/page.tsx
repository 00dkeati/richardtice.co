...
export const metadata: Metadata = {
  title: "Where Is Richard Tice From? | RichardTice.co",
  description: "Learn about where is richard tice from?. Richard Tice is the Deputy Leader of Reform UK and MP for Boston & Skegness. Net worth £40 million, engaged to Isabel Oakeshott.",
  keywords: ["where", "is", "richard", "tice", "from", "richard tice", "reform uk", "boston skegness mp"],
  openGraph: {
    title: "Where Is Richard Tice From?",
    description: "Learn about where is richard tice from?. Richard Tice - Reform UK Deputy Leader.",
    url: "https://richardtice.co/where-is-richard-tice-from",
    ...
    <main className="min-h-screen bg-slate-900">
      ...
      <section className="py-12 bg-gradient-to-b from-slate-800 to-slate-900">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">Where Is Richard Tice From?</h1>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            "headline": "Where Is Richard Tice From?",
