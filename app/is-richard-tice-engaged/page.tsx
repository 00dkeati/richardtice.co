...
export const metadata: Metadata = {
  title: "Is Richard Tice Engaged? | RichardTice.co",
  description: "Learn about is richard tice engaged?. Richard Tice is the Deputy Leader of Reform UK and MP for Boston & Skegness. Net worth £40 million, engaged to Isabel Oakeshott.",
  keywords: ["is", "richard", "tice", "engaged", "richard tice", "reform uk", "boston skegness mp"],
  openGraph: {
    title: "Is Richard Tice Engaged?",
    description: "Learn about is richard tice engaged?. Richard Tice - Reform UK Deputy Leader.",
    url: "https://richardtice.co/is-richard-tice-engaged",
    ...
    <main className="min-h-screen bg-slate-900">
      ...
      <section className="py-12 bg-gradient-to-b from-slate-800 to-slate-900">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">Is Richard Tice Engaged?</h1>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            "headline": "Is Richard Tice Engaged?",
