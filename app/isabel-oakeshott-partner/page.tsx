...
export const metadata: Metadata = {
  title: "Isabel Oakeshott Partner Richard Tice | RichardTice.co",
  description: "Learn about isabel oakeshott partner richard tice. Richard Tice is the Deputy Leader of Reform UK and MP for Boston & Skegness. Net worth £40 million, engaged to Isabel Oakeshott.",
  keywords: ["isabel", "oakeshott", "partner", "richard tice", "reform uk", "boston skegness mp"],
  openGraph: {
    title: "Isabel Oakeshott Partner Richard Tice",
    description: "Learn about isabel oakeshott partner richard tice. Richard Tice - Reform UK Deputy Leader.",
    url: "https://richardtice.co/isabel-oakeshott-partner",
    ...
    <main className="min-h-screen bg-slate-900">
      ...
      <section className="py-12 bg-gradient-to-b from-slate-800 to-slate-900">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">Isabel Oakeshott Partner Richard Tice</h1>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            "headline": "Isabel Oakeshott Partner Richard Tice",
