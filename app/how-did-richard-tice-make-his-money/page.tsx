...
export const metadata: Metadata = {
  title: "How Did Richard Tice Make His Money? | RichardTice.co",
  description: "Learn about how did richard tice make his money?. Richard Tice is the Deputy Leader of Reform UK and MP for Boston & Skegness. Net worth £40 million, engaged to Isabel Oakeshott.",
  keywords: ["how", "did", "richard", "tice", "make", "his", "money", "richard tice", "reform uk", "boston skegness mp"],
  openGraph: {
    title: "How Did Richard Tice Make His Money?",
    description: "Learn about how did richard tice make his money?. Richard Tice - Reform UK Deputy Leader.",
    url: "https://richardtice.co/how-did-richard-tice-make-his-money",
    ...
    <main className="min-h-screen bg-slate-900">
      ...
      <section className="py-12 bg-gradient-to-b from-slate-800 to-slate-900">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">How Did Richard Tice Make His Money?</h1>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            "headline": "How Did Richard Tice Make His Money?",
