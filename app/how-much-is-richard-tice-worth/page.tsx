...
export const metadata: Metadata = {
  title: "How Much Is Richard Tice Worth? | RichardTice.co",
  description: "Learn about how much is richard tice worth?. Richard Tice is the Deputy Leader of Reform UK and MP for Boston & Skegness. Net worth £40 million, engaged to Isabel Oakeshott.",
  keywords: ["how", "much", "is", "richard", "tice", "worth", "richard tice", "reform uk", "boston skegness mp"],
  openGraph: {
    title: "How Much Is Richard Tice Worth?",
    description: "Learn about how much is richard tice worth?. Richard Tice - Reform UK Deputy Leader.",
    url: "https://richardtice.co/how-much-is-richard-tice-worth",
    ...
    <main className="min-h-screen bg-slate-900">
      ...
      <section className="py-12 bg-gradient-to-b from-slate-800 to-slate-900">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">How Much Is Richard Tice Worth?</h1>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            "headline": "How Much Is Richard Tice Worth?",
