...
export const metadata: Metadata = {
  title: "Richard Tice Height - How Tall? | RichardTice.co",
  description: "Learn about richard tice height - how tall?. Richard Tice is the Deputy Leader of Reform UK and MP for Boston & Skegness. Net worth £40 million, engaged to Isabel Oakeshott.",
  keywords: ["richard", "tice", "height", "richard tice", "reform uk", "boston skegness mp"],
  openGraph: {
    title: "Richard Tice Height - How Tall?",
    description: "Learn about richard tice height - how tall?. Richard Tice - Reform UK Deputy Leader.",
    url: "https://richardtice.co/richard-tice-height",
    ...
    <main className="min-h-screen bg-slate-900">
      ...
      <section className="py-12 bg-gradient-to-b from-slate-800 to-slate-900">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">Richard Tice Height - How Tall?</h1>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            "headline": "Richard Tice Height - How Tall?",
